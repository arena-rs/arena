...
interface V3Fuzzer {
    ...
    function uniswapV3MintCallback(uint256 amount0Owed, uint256 amount1Owed, bytes memory) external;
        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            for UnderlyingRustTuple<'_> {
                fn from(value: uniswapV3MintCallbackCall) -> Self {
                    (value.amount0Owed, value.amount1Owed, value._2)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
...
```*/
        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            for UnderlyingRustTuple<'_> {
                fn from(value: uniswapV3SwapCallbackCall) -> Self {
                    (value.amount0Delta, value.amount1Delta, value._2)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
    ...
    ///Container for all the [`V3Fuzzer`](self) function calls.
    pub enum V3FuzzerCalls {
        IS_TEST(IS_TESTCall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for V3FuzzerCalls {
        const NAME: &'static str = "V3FuzzerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<V3FuzzerCalls>] = &[
                {
                    fn setUp(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn excludeSenders(
                        ...
                        <excludeSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    fn targetInterfaces(
                        ...
                        <targetInterfacesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    fn REMOVE_LIQUIDITY_PARAMS(
                        ...
                        <REMOVE_LIQUIDITY_PARAMSCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::REMOVE_LIQUIDITY_PARAMS)
                    }
                ...
                },
                {
                    fn targetSenders(
                        ...
                        <targetSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    fn targetContracts(
                        ...
                        <targetContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    fn MAX_PRICE_LIMIT(
                        ...
                        <MAX_PRICE_LIMITCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::MAX_PRICE_LIMIT)
                    }
                    MAX_PRICE_LIMIT
                },
                {
                    fn targetArtifactSelectors(
                        ...
                        <targetArtifactSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::targetArtifactSelectors)
                    }
                ...
                },
                {
                    fn targetArtifacts(
                        ...
                        <targetArtifactsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    fn targetSelectors(
                        ...
                        <targetSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                    fn LIQUIDITY_PARAMS(
                        ...
                        <LIQUIDITY_PARAMSCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::LIQUIDITY_PARAMS)
                    }
                    LIQUIDITY_PARAMS
                },
                {
                ...
                },
                {
                    fn excludeArtifacts(
                        ...
                        <excludeArtifactsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                ...
                },
                {
                    fn MIN_PRICE_LIMIT(
                        ...
                        <MIN_PRICE_LIMITCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::MIN_PRICE_LIMIT)
                    }
                    MIN_PRICE_LIMIT
                },
                {
                    fn uniswapV3MintCallback(
                        ...
                        <uniswapV3MintCallbackCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::uniswapV3MintCallback)
                    }
                ...
                },
                {
                    fn excludeContracts(
                        ...
                        <excludeContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
                    fn uniswapV3SwapCallback(
                        ...
                        <uniswapV3SwapCallbackCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(V3FuzzerCalls::uniswapV3SwapCallback)
                    }
    ...
    ///Container for all the [`V3Fuzzer`](self) events.
    pub enum V3FuzzerEvents {
        log(log),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for V3FuzzerEvents {
        const NAME: &'static str = "V3FuzzerEvents";
    ...
    /**Creates a new wrapper around an on-chain [`V3Fuzzer`](self) contract instance.

See the [wrapper's documentation](`V3FuzzerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> V3FuzzerInstance<T, P, N> {
        V3FuzzerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<V3FuzzerInstance<T, P, N>>,
    > {
        V3FuzzerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        V3FuzzerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`V3Fuzzer`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`V3Fuzzer`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct V3FuzzerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for V3FuzzerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("V3FuzzerInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<V3FuzzerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> V3FuzzerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> V3FuzzerInstance<T, P, N> {
            V3FuzzerInstance {
